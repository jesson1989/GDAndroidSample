...
public class TimeAxleAdapter extends
        RecyclerView.Adapter<TimeAxleAdapter.MyViewHolder> {

    List<TrackingInfo> lists;
    Context mContext;

    public TimeAxleAdapter(List<TrackingInfo> lists, Context mContext) {
        super();
        this.lists = lists;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup arg0, int arg1) {
        ...
        View view = inflater.inflate(R.layout.item_tracking, arg0, false);
